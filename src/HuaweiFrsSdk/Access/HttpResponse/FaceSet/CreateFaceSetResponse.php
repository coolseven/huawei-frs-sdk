...
use HuaweiFrsSdk\Client\Result\FaceSet\CreateFaceSetResult;
use HuaweiFrsSdk\Exceptions\ResponseValidationException;

class CreateFaceSetResponse extends AbstractResponse
{
    /**
    ...
    public function getResult() : CreateFaceSetResult
    {
